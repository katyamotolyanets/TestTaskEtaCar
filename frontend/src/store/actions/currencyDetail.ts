...
import {CurrencyDetailAction, CurrencyDetailActionTypes, CurrencyDetailType} from "../../types/currencyDetail";
...
export const fetchCurrencyHistory = (data: void[]) => {
    return async (dispatch: Dispatch<CurrencyDetailAction>) => {
        dispatch({type: CurrencyDetailActionTypes.FETCH_CURRENCY_HISTORY, payload: data})
    }
}